...
public class GetWatchHistory_CSR {
	private String sApiName = "GetWatchHistory_CSR";
	private String sURL, sUser;	
	private Map<String, String> mapParams;
	
	public GetWatchHistory_CSR(String user, AppUtils.Env env, String token)
	{
	...
	public String doGetWatchHistory_CSR(String pcn, String startdate, String enddate)
	{
