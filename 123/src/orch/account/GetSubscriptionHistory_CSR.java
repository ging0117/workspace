...
public class GetSubscriptionHistory_CSR {
	private String sApiName = "GetSubscriptionHistory_CSR";
	private String sURL, sUser;	
	private Map<String, String> mapParams;
	
	public GetSubscriptionHistory_CSR(String user, AppUtils.Env env, String token)
	{
	...
	public String doGetSubscriptionHistory_CSR(String pcn, String startdate, String enddate)
	{
